...
- Scene content depends on `src/content/portfolioNodes.js` (including per-node optional glyph metadata such as AI Guide `/glb/glyph_1.glb` and Creative AI `/glb/glyph_2.glb`).
