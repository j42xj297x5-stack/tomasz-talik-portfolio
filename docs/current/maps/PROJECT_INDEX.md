...
| Experience VR Rezonator Asterionowy, late Rune act and finale | [`concept/EXPERIENCE_VR_RUNES_RESONATOR_FINALE.md`](../concept/EXPERIENCE_VR_RUNES_RESONATOR_FINALE.md), then the progress-floor, Rune Stone and runtime models | Current working canon replaces the earlier three-sector full-antenna flow; runtime implementation remains future. |
