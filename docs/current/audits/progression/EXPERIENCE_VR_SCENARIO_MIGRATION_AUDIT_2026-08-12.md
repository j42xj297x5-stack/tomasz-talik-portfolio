...
| SG-039 | `src/xr/guidance/createVrIntroSequence.js:L84-L90` | calibration; fog complete; silence complete | Intro transitions and onboarding | TIMER_TRIGGER | Director clock/state | HIGH |
