...
- [ ] Reuse earned Asterion platform control as the aiming/orientation mechanic without moving progression ownership into the gyro.
- [ ] Define sector feedback, readability and Quest comfort constraints.

## FUTURE

- [ ] Progression-unlocked Astro bands selected with B; no band grants global raycasting.
- [ ] Small glyphs and GREEN capability after Sphere construction.
- [ ] Controllable antenna sectors and readable alignment/lensing feedback.
- [ ] Astro upgrade recipes and Emanation Matrix rune processing.
- [ ] BLUE rune targeting, stored emanation progression, ULTRAVIOLET distant glyphs and final radar/reliquary finale.
- [ ] Authored post-P0 Monkey narrative and stuck-player guidance.
- [ ] Spatial audio, future target/process audio, durable persistence and full-game reset.
