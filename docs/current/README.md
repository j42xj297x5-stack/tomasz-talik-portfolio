...
`docs/current/` is the active source of truth for this project.

## Sections

- `maps/` — navigation, placement rules, and dependency maps.
- `technical/` — current architecture and implementation models.
...
- [`maps/PROJECT_INDEX.md`](maps/PROJECT_INDEX.md)
