...
- `createVrCrystalCollection` owns deterministic floor spawn, separate target-ray crystal hits, `available`/`pulling`/`held`/`consumed` state, squeeze pull-to-hand, non-physical release, portal insertion, and reset.
