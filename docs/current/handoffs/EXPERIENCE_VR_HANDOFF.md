...
## Intro background audio

Canonical Scenario entries sterują pięcioma cue Intro: `01` dla `1.10–1.30`, `02` dla `1.40–1.60`, `03` dla `1.70–1.90`, `04` dla `1.100–1.110` i `05` dla `1.120–1.130`. Actor zapętla kopie z 5-sekundowym authored overlapem, nie restartuje tego samego cue i przy zmianie wygasza cały outgoing output przez 5 s. Entry `2.10` jest jedynym handoffem: wygasza Intro i odblokowuje istniejący main ambient sequencer od `ambient_01`. Reset ponownie zamyka gate; cue pozostają transient i nie są hydratowane. Assety `ambient_intro_06–08` pozostają RESERVED / UNASSIGNED.
