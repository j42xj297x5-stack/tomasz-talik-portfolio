...
- The deliberately retained technical points are `2.10.1`, `2.30.1`, and `2.40.1`. Hint-point migration, the `5/5` condition point, arbitrary start, hydration, and reconstruction-backed QA aliases are **NOT IMPLEMENTED**.
