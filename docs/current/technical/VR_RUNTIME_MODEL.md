...
The runtime supplies channels and current progress/history behavior only. Narrative sequencing, authored Monkey messages, quests, personality and stuck-player logic are **NOT DESIGNED / FUTURE**.
