...
Status: canonical description of the implemented runtime synchronized on 2026-08-05. Approved future gameplay is documented in the [gameplay roadmap](../concept/EXPERIENCE_VR_GAMEPLAY_ROADMAP.md).
...
Not implemented: production physical Asterion Sphere construction, production equipment gating, `UTWÓRZ`, production 6/6 materialization, small glyph progression, B band selection/Astro bands, antenna, rune processing, final radar/finale, durable persistence, full-game reset and audio.
