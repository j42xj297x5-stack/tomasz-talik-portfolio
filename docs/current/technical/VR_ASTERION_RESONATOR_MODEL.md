...
Still separate or **NOT IMPLEMENTED**: lightning visual branching/upgrade, detent sparks, drive/detent and field audio, `RUNE_INSTALL` VFX/audio, Field Presentation and target response.
