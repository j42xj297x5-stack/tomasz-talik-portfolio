...
- Sun and moon share one progression multiplier applied to their configured base spotlight intensities. It starts at 60%, rises evenly through 70%, 80%, and 90% as the first three layers unlock, reaches 100% at the stars layer, and remains at 100% for galaxies; disabling progression returns the multiplier to 100%.
