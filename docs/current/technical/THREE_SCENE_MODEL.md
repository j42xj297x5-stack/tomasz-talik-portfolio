...
- Atmosphere progression starts with shells, then adds small glyphs, stars, animated stones, and finally galaxies together with the Milky Way. Previously revealed layers remain visible at every later level, while level zero and progression reset hide all five atmosphere layers.
