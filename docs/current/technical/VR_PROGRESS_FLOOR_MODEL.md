...
W zatwierdzonym, niezaimplementowanym Rune Stone Act antenna hunt dostarcza kryształy Metal + Water kończące Tier 4. Commit domyka Metal do `4/4`, ale Water pozostaje celowo `4/5`. Pełny sektor Metal daje normalne eligibility Metal Rune Stone; Water zachowuje deadlock aż specjalny Eter beat nada Water-only knowledge override. Override nie dopisuje panelu i nie zmienia floor truth. Dopiero ostatni Water Crystal po instalacji pięciu elementarnych Rune Stones i sukcesie `FINAL_WATER_HUNT` przechodzi przez Reliquary, commituje Water `5/5` i domyka Tier 5.
