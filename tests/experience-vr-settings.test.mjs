...
assert.equal('emergeDuration' in DEFAULT_EXPERIENCE_VR_SETTINGS.intro, false);
...
assert.equal(DEFAULT_EXPERIENCE_VR_SETTINGS.observationWindow.durationSeconds, 10);
