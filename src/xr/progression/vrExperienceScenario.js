...
export const VR_SCENARIO_EVENT = immutableIdentifiers([
  ...
  'END_CREDITS_COMPLETED',
  'END_BRAND_SLATE_COMPLETED',
  'XR_SESSION_ENDING',
  'XR_SESSION_ENDED',
...
export const VR_SCENARIO_EFFECT = immutableIdentifiers([
  ...
  'BEGIN_SMALL_GLYPH_WORLD_REVEAL',
  'REVEAL_ETHER_RUNE',
  'BEGIN_INTRO_REVEAL',
...
const END_CREDITS_SETTLED_CONSEQUENCES = Object.freeze({
  endCredits: Object.freeze({ completed: true })
});
...
const points = Object.freeze([
  ...
  Object.freeze({
    ...
    entryEffects: Object.freeze([VR_SCENARIO_EFFECT.SET_MAIN_AMBIENT_01,
      ...
      VR_SCENARIO_EFFECT.BEGIN_SHELL_FIELD_WORLD_REVEAL, VR_SCENARIO_EFFECT.BEGIN_SMALL_GLYPH_WORLD_REVEAL,
  ...
  Object.freeze({
    ...
    capabilities: Object.freeze([]),
    transitions: Object.freeze([Object.freeze({ kind: VR_SCENARIO_TRANSITION_KIND.COMPLETE,
      event: VR_SCENARIO_EVENT.END_CREDITS_COMPLETED, milestonesToAdd: Object.freeze([]) })])
  }),
  Object.freeze({
    ...
    capabilities: Object.freeze([]),
    transitions: Object.freeze([Object.freeze({ kind: VR_SCENARIO_TRANSITION_KIND.COMPLETE,
      event: VR_SCENARIO_EVENT.END_BRAND_SLATE_COMPLETED, milestonesToAdd: Object.freeze([]) })])
  }),
  Object.freeze({
