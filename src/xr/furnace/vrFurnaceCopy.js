...
export const VR_FURNACE_COPY = Object.freeze({
  pl: createCopy({
    home: { title: 'ASTRO PIEC', eyebrow: 'MODUŁY TRANSFORMACJI', asterionMetric: 'SKORUPY',
      asterionAvailable: '{absorbed} / 6   DOSTĘPNE', astrolabiumMetric: 'STATUS',
  ...
  en: createCopy({
    home: { title: 'ASTRO FURNACE', eyebrow: 'MODULES OF TRANSFORMATION', asterionMetric: 'SHELLS', asterionAvailable: '{absorbed} / 6   AVAILABLE', astrolabiumMetric: 'STATUS', astrolabiumStates: { AVAILABLE: 'READY // COLLECT', EARNED: 'TUNING', DEFAULT: 'ENTER MODULE' } },
    navigation: { backModules: '← MODULES' }, asterion: { title: 'ASTERION SPHERE', detail: 'Gyroscopic ring-control core' },
    astrolabium: { title: 'ASTROLABE OF BONDING', detail: 'Attraction and synchronization tool', menuEyebrow: 'SYNCHRONIZATION TOOLS', menu: { create: ['BUILD THE ASTROLABE OF BONDING', 'Materialize the tool in the Astro Furnace'], glyphTuning: ['GLYPH TUNING', 'Permanent Small Glyph configuration'], runeTuning: ['TUNE THE RUNE STONES', 'Wu Xing family recipes'] } },
    ...
    glyphTuning: { title: 'ASTROLABE TUNING', detail: 'Permanent Astrolabe of Bonding configuration', section: 'SMALL GLYPHS', states: { tuned: 'TUNED', processing: 'PROCESSING', ready: 'READY', inactive: 'INACTIVE' } },
