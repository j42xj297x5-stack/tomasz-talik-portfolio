const VR_PLAYER_GUIDE_CONTENT = Object.freeze({
  pl: Object.freeze({
    ...
    controlsDetailHint: 'X — ustawienia obrotu · Y — wróć',
    controlsSettingsHint: 'Lewy drążek — wybór · X — zmień · Y — wróć',
  ...
  en: Object.freeze({
    ...
    controlsDetailHint: 'X — turn settings · Y — back',
    controlsSettingsHint: 'Left stick — select · X — change · Y — back',
