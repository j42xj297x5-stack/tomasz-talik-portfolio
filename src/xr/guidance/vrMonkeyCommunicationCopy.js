...
export const VR_MONKEY_COMMUNICATION_COPY_PL = Object.freeze({
  progression: Object.freeze({
    ...
    'progression.intro.afterPlayerGuide': { blocks: ['Jak zapomnisz — przypomnę.', 'Zobaczmny, czy świat cię słucha.', 'Wskaż mnie.'] },
    ...
    'progression.postRing.changedWorld': { blocks: ['No i świat przestał być uprzejmy.', 'To, czego potrzebujesz, jest teraz poza zasięgiem.\nNa szczęście nie na długo.'] },
    'progression.furnace.look': { blocks: ['Spójrz na Piec.', 'Tam coś na ciebie czeka.'] },
    'progression.p2.smallGlyphsIntro': { blocks: ['Świat idzie do przodu. Ty też powinieneś.\nGlify możesz przyciągnąć.\nNajpierw jednak trzeba je dostroić.'] },
  ...
  decisions: Object.freeze({
    ...
    'decision.threshold.enter': { blocks: ['Dalej jest próg.\nMożesz go nie przekraczać.\nJeśli przekroczysz — wrócisz dopiero wtedy, kiedy droga się skończy.'], question: 'Wchodzisz?', options: ['PRZEKRACZAM PRÓG', 'CO JEST PO DRUGIEJ STRONIE?', 'WRACAM'] },
  ...
  knowledge: Object.freeze({
    ...
    'knowledge.astro.why': { groupId: 'astro', policy: 'ONCE', question: 'A PO CO MI TO?', blocks: ['Żebyś mógł sięgnąć trochę dalej.\nGlify niestety trochę ci uciekły.', 'Tak już to zaprojektowano.'] },
    ...
    'knowledge.intro.where': { groupId: 'intro', policy: 'CONTEXTUAL', question: 'DOKĄD?', blocks: ['Gdybym ci powiedział, poszedłbyś do odpowiedzi.\nA ja pytam, czy pójdziesz za mną.'] },
    ...
    'knowledge.p2.tuneGlyphs': { groupId: 'p2', policy: 'CONTEXTUAL', question: 'JAK DOSTROIĆ GLIFY?', blocks: ['Małe glify są sprzężone z dużymi.\nPomogą Astrolabium je rozpoznać.', 'Przycisk B zmienia to, czego narzędzie szuka.'] }
  })
});
