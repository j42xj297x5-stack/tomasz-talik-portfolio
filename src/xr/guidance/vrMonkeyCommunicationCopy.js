...
export const VR_MONKEY_COMMUNICATION_COPY_PL = shallowFreeze({
  "progression": {
    ...
    "progression.intro.openPlayerGuide": {
      ...
      "prompt": "Naciśnij Y, żeby wejść do menu."
    },
    "progression.intro.afterPlayerGuide": {
      "blocks": [
    ...
    "progression.glyphs.firstDiscovery": {
      "blocks": [
    ...
    "progression.p3.firstRuneInstalledWithAsterion": {
      "blocks": [
        "O.",
    ...
    "progression.p3.firstRuneInstalledWithoutAsterion": {
      "blocks": [
        "O.",
        "Sam wiedział, gdzie ma trafić.",
        "Teraz możesz kontrolować jedną część.\nŻeby znaleźć glify, potrzebujesz trzech.",
    ...
    "progression.p4.etherIntervention": {
      "blocks": [
        "Cztery.",
        "Została Woda.",
    ...
    "progression.final.monkeyFarewell": {
      "blocks": [
        "Ukończyłeś drogę.",
  ...
  "knowledge": {
    ...
    "knowledge.threshold.otherSide": {
      "groupId": "threshold",
      "policy": "CONTEXTUAL",
      "question": "CO JEST PO DRUGIEJ STRONIE?",
      "blocks": [
    ...
    "knowledge.threshold.easier": {
      "groupId": "threshold",
      "policy": "CONTEXTUAL",
      "question": "DLACZEGO ŁATWIEJ?",
      "blocks": [
        "Nie musisz już wybierać, czy wejść."
      ]
    },
    "knowledge.p3.stonesLead": {
      "groupId": "currentGuidance",
...
export const VR_MONKEY_COMMUNICATION_COPY_EN = shallowFreeze({
  "progression": {
    ...
    "progression.intro.openPlayerGuide": {
      ...
      "prompt": "Press Y to open the menu."
    },
    "progression.intro.afterPlayerGuide": {
      "blocks": [
  ...
  "knowledge": {
    ...
    "knowledge.p3.stonesLead": {
      "groupId": "currentGuidance",
      "question": "There are still stones left.",
      "blocks": [
...
export function resolveVrMonkeyCommunicationCopy(locale = 'en') {
  return locale === 'pl' ? VR_MONKEY_COMMUNICATION_COPY_PL : VR_MONKEY_COMMUNICATION_COPY_EN;
}
