...
const sceneRuntimeConfig = {
  backgroundAtmosphere: {
    ...
    stoneRelics: { enabled: true, count: 60, models: ['/glb/stone_01.glb','/glb/stone_02.glb','/glb/stone_03.glb','/glb/stone_04.glb','/glb/stone_05.glb','/glb/stone_06.glb'], safeRadius: 3.5, shellInnerRadius: 5, shellOuterRadius: 8, minScale: 1, maxScale: 2, rotationSpeedMin: 0.003, rotationSpeedMax: 0.018, orbitSpeed: 0.003, opacity: 0.85, debugVisible: false },
    shellRelics: {
      enabled: true,
      count: 35,
